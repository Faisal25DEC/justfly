...
const featuresData: Feature[] = [
  {
    ...
    paragraph:
      "We pride ourselves on offering competitive prices for flights to destinations all around the world. Our team works tirelessly to find the best deals, ensuring you get the most value for your money.",
  },
  {
    id: 1,
    icon: (
    ...
    paragraph:
      "We believe that every traveler is unique, and so are their needs. Our experienced travel experts are dedicated to providing personalized assistance, tailoring your trip to your preferences and budget.",
  },
  {
    id: 1,
    icon: (
    ...
    paragraph:
      " With access to a vast network of airlines, we can help you find flights to even the most remote destinations. Whether it's a major city or a hidden gem, we can get you there.",
  },
];
